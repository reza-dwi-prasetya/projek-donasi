    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="<?php echo e(route('causes')); ?>" class="nav-item nav-link">Causes</a>
                <a class="nav-link" href="<?php echo e(route('kalkulator-zakat.create')); ?>">Zakat Calculator</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                    <div class="dropdown-menu m-0">
                        <a href="<?php echo e(route('service')); ?>" class="dropdown-item">Service</a>
                        <a href="<?php echo e(route('donate')); ?>" class="dropdown-item">Donate</a>
                        <a href="<?php echo e(route('team')); ?>" class="dropdown-item">Our Team</a>
                    </div>
                </div>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="<?php echo e(route('statistics')); ?>" class="dropdown-item">Statistics</a>
                        <a href="<?php echo e(route('riwayat.index')); ?>" class="dropdown-item">Donation Reports</a>
                        <a href="<?php echo e(route('expenditures')); ?>" class="dropdown-item">Expenditure Reports</a>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="d-none d-lg-flex ms-2">
                <a class="btn btn-outline-primary py-2 px-3" href="<?php echo e(route('donate')); ?>">
                    Donate Now
            ...
            <div class="d-none d-lg-flex ms-2">
                ...
                <?php else: ?>
                    <a class="btn btn-outline-primary py-2 px-3" href="<?php echo e(route('login')); ?>">
                        Login
                        <div class="d-inline-flex btn-sm-square bg-white text-primary rounded-circle ms-2">
                            <i class="fa fa-arrow-right"></i>
                        </div>
...
<!-- Navbar End -->
<?php /**PATH C:\laragon\www\Projek _Donasi(V2)\resources\views/includes/navbar.blade.php ENDPATH**/ ?>